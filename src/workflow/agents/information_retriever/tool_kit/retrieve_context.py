...
class RetrieveContext(Tool):
    ...
    def __init__(self, top_k: int):
        super().__init__()
        # print("\n\n*******Initialized Retriever Context here********")
        # print(f"*****TopK: {top_k}********\n\n")
        self.top_k = top_k
    ...
    def _run(self, state: SystemState):
        ...
        """
        # print("\n\n******Inside the run of Retrieve Context**********")
        ...
        # print(f"**********Retrieved columns are : {retrieved_columns}************")
        state.schema_with_descriptions = self._format_retrieved_descriptions(retrieved_columns)
        # print(f"**********Schema Description is : {self._format_retrieved_descriptions(retrieved_columns)}************\n\n")
        # try:
    ...
    def _find_most_similar_columns(self, question: str, evidence: str, keywords: List[str], top_k: int) -> Dict[str, Dict[str, Dict[str, str]]]:
        ...
        # print("\n\n******Inside the _find_most_similar_columns() **********")
        ...
        for keyword in keywords:
            ...
            # print(f"********Retrieved question and evidence: {retrieved_question_based_query} and {retrieved_evidence_based_query}******")
